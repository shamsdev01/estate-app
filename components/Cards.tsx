        ...
        <TouchableOpacity className='flex flex-col items-start w-60 h-80 relative'> 
                ...
                <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
                        ...
                        <Text className='text-base font-rubik text-white'>
                            22 W Main St, New York
                        </Text>
                        <View className='flex flex-row items-center justify-between w-full'>
                             <Text className='text-xl font-rubik-extrabold text-white'>$12,219</Text> 
                             <Image
                                source={icons.heart}
                                className='size-6'
  ...
  return (
    ...
    >
      ...
      <View className="flex flex-col mt-2">
        ...
        <Text className="text-xs font-rubik text-black-200">22 W Main St, New York</Text>
        <View className="flex flex-row items-center justify-between mt-2">
          <Text className="text-base font-rubik-bold text-primary-300">$12,219</Text>
          <Image
            source={icons.heart}
